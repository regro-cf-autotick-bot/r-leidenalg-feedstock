      ...
      <details>
        ...
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14886&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-leidenalg-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_arm64_r_base4.5" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
pixi add r-leidenalg
# for installing globally
pixi global install r-leidenalg
```
...
It is possible to list all of the versions of `r-leidenalg` available on your platform:
...
```
pixi search r-leidenalg --channel conda-forge
```
